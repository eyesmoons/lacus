...
// */
//public class DorisWriterBak extends BaseWriter {
//
//    public DorisWriterBak() {
//        super(DORIS_WRITER);
//    }
//
//    @Override
...
//        List<String> topics = sourceConfig.getTopics();
//        String bootStrapServers = sourceConfig.getBootStrapServers();
//        // read from kafka
//        DataStreamSource<ConsumerRecord<String, String>> kafkaSourceDs = env.fromSource(KafkaUtil.getKafkaSource(bootStrapServers, topics, sourceConfig.getGroupId()), WatermarkStrategy.noWatermarks(), "kafka_source");
//        // kafka消息过滤
