package com.lacus.sink.starrocks;
...
import com.lacus.sink.doris.DorisSinkFunction;
import com.lacus.sink.doris.DorisStreamLoad;
...
import static com.lacus.constant.ConnectorContext.STARROCKS_SINK;
...
public class StarRocksSink extends BaseSink {
    private static final long serialVersionUID = 1L;

    public StarRocksSink() {
        super(STARROCKS_SINK);
    }
