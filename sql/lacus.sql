...
(1,'平台管理',0,7,'system',NULL,'',0,1,1,1,1,'','system',0,'2022-05-21 08:30:54',1,'2025-03-23 16:06:19','系统管理目录',0),
(2,'系统监控',0,9,'monitor',NULL,'',0,1,1,1,1,'','monitor',0,'2022-05-21 08:30:54',1,'2025-03-23 16:06:11','系统监控目录',0),
(3,'系统工具',0,4,'tool',NULL,'',0,1,1,1,1,'','tool',0,'2022-05-21 08:30:54',1,'2023-04-24 21:51:30','系统工具目录',1),
(4,'官网文档',0,5,'https://juejin.cn/column/7159946528827080734',NULL,'',1,1,1,1,1,'','guide',0,'2022-05-21 08:30:54',1,'2023-04-26 09:14:48','pandora官网地址',1),
(5,'用户管理',1,1,'user','system/user/index','',0,1,2,1,1,'system:user:list','user',0,'2022-05-21 08:30:54',NULL,NULL,'用户管理菜单',0),
(6,'角色管理',1,2,'role','system/role/index','',0,1,2,1,1,'system:role:list','email',0,'2022-05-21 08:30:54',1,'2023-09-04 10:58:41','角色管理菜单',0),
(7,'菜单管理',1,3,'menu','system/menu/index','',0,1,2,1,1,'system:menu:list','tree-table',0,'2022-05-21 08:30:54',NULL,NULL,'菜单管理菜单',0),
(8,'部门管理',1,4,'dept','system/dept/index','',0,1,2,1,1,'system:dept:list','tree',0,'2022-05-21 08:30:54',NULL,NULL,'部门管理菜单',0),
(9,'岗位管理',1,5,'post','system/post/index','',0,1,2,1,1,'system:post:list','post',0,'2022-05-21 08:30:54',NULL,NULL,'岗位管理菜单',0),
(10,'参数设置',1,7,'config','system/config/index','',0,1,2,1,1,'system:config:list','edit',0,'2022-05-21 08:30:54',NULL,NULL,'参数设置菜单',1);
INSERT INTO sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,is_external,is_cache,menu_type,is_visible,status,perms,icon,creator_id,create_time,updater_id,update_time,remark,deleted) VALUES
...
(12,'日志管理',2,9,'log','','',0,1,1,1,1,'','log',0,'2022-05-21 08:30:54',1,'2024-05-02 17:52:06','日志管理菜单',0),
(13,'在线用户',2,1,'online','monitor/online/index','',0,1,2,1,1,'monitor:online:list','online',0,'2022-05-21 08:30:54',NULL,NULL,'在线用户菜单',0),
...
(16,'缓存监控',2,5,'cache','monitor/cache/index','',0,1,2,1,1,'monitor:cache:list','redis',0,'2022-05-21 08:30:54',NULL,NULL,'缓存监控菜单',0),
...
(20,'用户查询',5,1,'','','',0,1,3,1,1,'system:user:query','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0);
INSERT INTO sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,is_external,is_cache,menu_type,is_visible,status,perms,icon,creator_id,create_time,updater_id,update_time,remark,deleted) VALUES
(21,'用户新增',5,2,'','','',0,1,3,1,1,'system:user:add','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(22,'用户修改',5,3,'','','',0,1,3,1,1,'system:user:edit','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(23,'用户删除',5,4,'','','',0,1,3,1,1,'system:user:remove','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(24,'用户导出',5,5,'','','',0,1,3,1,1,'system:user:export','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(25,'用户导入',5,6,'','','',0,1,3,1,1,'system:user:import','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(26,'重置密码',5,7,'','','',0,1,3,1,1,'system:user:resetPwd','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(27,'角色查询',6,1,'','','',0,1,3,1,1,'system:role:query','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(28,'角色新增',6,2,'','','',0,1,3,1,1,'system:role:add','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(29,'角色修改',6,3,'','','',0,1,3,1,1,'system:role:edit','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(30,'角色删除',6,4,'','','',0,1,3,1,1,'system:role:remove','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0);
INSERT INTO sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,is_external,is_cache,menu_type,is_visible,status,perms,icon,creator_id,create_time,updater_id,update_time,remark,deleted) VALUES
(31,'角色导出',6,5,'','','',0,1,3,1,1,'system:role:export','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(32,'菜单查询',7,1,'','','',0,1,3,1,1,'system:menu:query','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(33,'菜单新增',7,2,'','','',0,1,3,1,1,'system:menu:add','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(34,'菜单修改',7,3,'','','',0,1,3,1,1,'system:menu:edit','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(35,'菜单删除',7,4,'','','',0,1,3,1,1,'system:menu:remove','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(36,'部门查询',8,1,'','','',0,1,3,1,1,'system:dept:query','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(37,'部门新增',8,2,'','','',0,1,3,1,1,'system:dept:add','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(38,'部门修改',8,3,'','','',0,1,3,1,1,'system:dept:edit','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(39,'部门删除',8,4,'','','',0,1,3,1,1,'system:dept:remove','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(40,'岗位查询',9,1,'','','',0,1,3,1,1,'system:post:query','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0);
INSERT INTO sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,is_external,is_cache,menu_type,is_visible,status,perms,icon,creator_id,create_time,updater_id,update_time,remark,deleted) VALUES
(41,'岗位新增',9,2,'','','',0,1,3,1,1,'system:post:add','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(42,'岗位修改',9,3,'','','',0,1,3,1,1,'system:post:edit','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(43,'岗位删除',9,4,'','','',0,1,3,1,1,'system:post:remove','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(44,'岗位导出',9,5,'','','',0,1,3,1,1,'system:post:export','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(45,'参数查询',10,1,'#','','',0,1,3,1,1,'system:config:query','#',0,'2022-05-21 08:30:54',NULL,NULL,'',1),
(46,'参数新增',10,2,'#','','',0,1,3,1,1,'system:config:add','#',0,'2022-05-21 08:30:54',NULL,NULL,'',1),
(47,'参数修改',10,3,'#','','',0,1,3,1,1,'system:config:edit','#',0,'2022-05-21 08:30:54',NULL,NULL,'',1),
(48,'参数删除',10,4,'#','','',0,1,3,1,1,'system:config:remove','#',0,'2022-05-21 08:30:54',NULL,NULL,'',1),
(49,'参数导出',10,5,'#','','',0,1,3,1,1,'system:config:export','#',0,'2022-05-21 08:30:54',NULL,NULL,'',1),
(50,'公告查询',11,1,'#','','',0,1,3,1,1,'system:notice:query','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0);
INSERT INTO sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,is_external,is_cache,menu_type,is_visible,status,perms,icon,creator_id,create_time,updater_id,update_time,remark,deleted) VALUES
(51,'公告新增',11,2,'#','','',0,1,3,1,1,'system:notice:add','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(52,'公告修改',11,3,'#','','',0,1,3,1,1,'system:notice:edit','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(53,'公告删除',11,4,'#','','',0,1,3,1,1,'system:notice:remove','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(54,'操作查询',18,1,'#','','',0,1,3,1,1,'monitor:operlog:query','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(55,'操作删除',18,2,'#','','',0,1,3,1,1,'monitor:operlog:remove','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(56,'日志导出',18,4,'#','','',0,1,3,1,1,'monitor:operlog:export','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(57,'登录查询',19,1,'#','','',0,1,3,1,1,'monitor:logininfor:query','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(58,'登录删除',19,2,'#','','',0,1,3,1,1,'monitor:logininfor:remove','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(59,'日志导出',19,3,'#','','',0,1,3,1,1,'monitor:logininfor:export','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(60,'在线查询',13,1,'#','','',0,1,3,1,1,'monitor:online:query','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0);
INSERT INTO sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,is_external,is_cache,menu_type,is_visible,status,perms,icon,creator_id,create_time,updater_id,update_time,remark,deleted) VALUES
(61,'批量强退',13,2,'#','','',0,1,3,1,1,'monitor:online:batchLogout','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(62,'单条强退',13,3,'#','','',0,1,3,1,1,'monitor:online:forceLogout','#',0,'2022-05-21 08:30:54',NULL,NULL,'',0),
(2009,'元数据',0,1,'metadata',NULL,NULL,0,0,1,1,1,NULL,'redis',1,'2023-04-20 18:11:10',1,'2024-05-02 17:56:30','',0),
(2010,'数据源定义',2009,1,'datasource','metadata/datasource/index',NULL,0,0,2,1,1,'metadata:datasource:list','dict',1,'2023-04-20 18:13:53',1,'2024-03-23 19:58:29','',0),
(2011,'数据表查询',2009,2,'table','metadata/table/index',NULL,0,0,2,1,1,'metadata:table:list','table',1,'2023-04-24 17:58:27',1,'2024-03-23 19:58:36','',0),
(2012,'实时数据采集',0,2,'datasync',NULL,NULL,0,0,1,1,1,NULL,'example',1,'2023-05-10 17:36:09',1,'2025-05-18 15:32:10','',0),
(2013,'分组管理',2033,1,'catalog','datasync/catalog/index',NULL,0,0,2,1,1,'datasync:catalog:list','tool',1,'2023-05-10 17:43:08',1,'2025-03-23 15:32:45','',0),
(2014,'任务定义',2012,2,'job','datasync/job/index',NULL,0,0,2,1,1,'datasync:job:list','select',1,'2023-05-11 18:14:36',1,'2024-02-26 20:25:02','',0),
(2015,'接口文档',0,10,'tool',NULL,NULL,0,0,1,1,1,NULL,'tool',1,'2023-07-06 16:27:09',1,'2025-03-23 16:06:07','',0),
(2016,'系统接口',2015,1,'swagger','tool/swagger/index',NULL,0,1,2,1,1,'tool:swagger:list','swagger',1,'2023-07-06 16:28:21',NULL,NULL,'',0);
INSERT INTO sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,is_external,is_cache,menu_type,is_visible,status,perms,icon,creator_id,create_time,updater_id,update_time,remark,deleted) VALUES
(2017,'新增数据源',2010,1,'',NULL,NULL,0,0,3,0,1,'metadata:datasource:add','build',1,'2024-02-21 21:42:56',1,'2024-02-21 21:46:00','',0),
(2018,'编辑数据源',2010,2,'',NULL,NULL,0,0,3,0,1,'metadata:datasource:edit','log',1,'2024-02-21 21:47:12',1,'2024-03-23 19:59:18','',0),
(2019,'删除数据源',2010,3,'',NULL,NULL,0,0,3,0,1,'metadata:datasource:remove','checkbox',1,'2024-02-21 21:48:31',NULL,NULL,'',0),
...
(2025,'编辑任务',2014,2,'',NULL,NULL,0,0,3,0,1,'datasync:job:edit','#',1,'2024-02-21 21:53:25',NULL,NULL,'',0),
(2026,'删除任务',2014,3,'',NULL,NULL,0,0,3,0,1,'datasync:job:remove','#',1,'2024-02-21 21:53:48',NULL,NULL,'',0);
INSERT INTO sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,is_external,is_cache,menu_type,is_visible,status,perms,icon,creator_id,create_time,updater_id,update_time,remark,deleted) VALUES
(2027,'任务详情',2014,4,'',NULL,NULL,0,0,3,0,1,'datasync:job:query','#',1,'2024-02-21 21:54:04',NULL,NULL,'',0),
...
(2036,'任务定义',2035,1,'flink','flink/job/index',NULL,0,0,2,1,1,'flink:job:list','cascader',1,'2024-12-08 11:51:52',1,'2024-12-08 13:17:22','',0),
(2038,'任务实例',2035,2,'instance','flink/instance/index',NULL,0,0,2,1,1,'flink:job:list','button',1,'2024-12-17 21:14:41',1,'2024-12-17 21:18:13','',0);
INSERT INTO sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,is_external,is_cache,menu_type,is_visible,status,perms,icon,creator_id,create_time,updater_id,update_time,remark,deleted) VALUES
...
(2041,'任务定义',2040,1,'spark','spark/job/index',NULL,0,0,2,1,1,NULL,'button',1,'2025-01-01 17:58:33',NULL,NULL,'',0),
...
(2045,'数据集成',0,1,'dig',NULL,NULL,0,0,1,1,1,NULL,'date',1,'2025-07-13 20:48:28',NULL,NULL,'',0),
(2046,'任务定义',2045,1,'dig/job','dig/job/index',NULL,0,0,2,1,1,NULL,'date-range',1,'2025-07-13 20:49:34',1,'2025-07-13 21:17:42','',0),
(2047,'任务实例',2045,2,'dig/instance','dig/instance/index',NULL,0,0,2,1,1,NULL,'component',1,'2026-03-04 17:48:19',NULL,NULL,'',0),
(2048,'数据质量',0,2,'dataquality',NULL,NULL,0,0,1,1,1,NULL,'money',1,'2026-03-20 22:13:59',1,'2026-03-20 22:17:58','',0);
INSERT INTO sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,is_external,is_cache,menu_type,is_visible,status,perms,icon,creator_id,create_time,updater_id,update_time,remark,deleted) VALUES
(2049,'规则管理',2048,1,'dataquality/rule','dataquality/rule/index',NULL,0,0,2,1,1,NULL,'druid',1,'2026-03-20 22:16:03',NULL,NULL,'',0),
(2050,'执行记录',2048,2,'dataquality/result','dataquality/result/index',NULL,0,0,2,1,1,NULL,'row',1,'2026-03-20 22:17:26',NULL,NULL,'',0);
COMMIT;
...
CREATE TABLE `st_job` (
    ...
    engine_param varchar (5000) default null comment '引擎参数',
...
CREATE TABLE `st_task` (
    ...
    `connector_config` text COLLATE utf8mb4_bin COMMENT '连接器配置',
    `position` varchar(1000) default null comment '节点位置',
    `deleted` tinyint NOT NULL DEFAULT '0' COMMENT '删除标识：正常 0 删除 1',
