...
//     * @return 表单配置
//     */
//    public static Map<String, Object> buildFormConfig(String componentName) {
...
//            result.put("componentInfo", metadata);
//            result.put("formGroups", groupedFields);
//
//        } catch (Exception e) {
...
//     * 按标签分组字段
//     */
//    private static Map<String, List<Map<String, Object>>> groupFieldsByTag(Map<String, Object> fieldConfigs) {
...
//     * @return 验证规则
//     */
//    public static Map<String, Object> buildValidationRules(String componentName) {
//        Map<String, Object> result = new HashMap<>();
//
//        try {
//            if (!StComponentLoader.hasComponent(componentName)) {
...
//     * @return 默认值配置
//     */
//    public static Map<String, Object> buildDefaultValues(String componentName) {
//        Map<String, Object> result = new HashMap<>();
//
//        try {
//            if (!StComponentLoader.hasComponent(componentName)) {
