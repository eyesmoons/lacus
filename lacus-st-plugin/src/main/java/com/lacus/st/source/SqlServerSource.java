...
@StComponent(
        ...
        displayName = "SQL Server数据源",
        description = "从Microsoft SQL Server数据库读取数据",
        version = "2.0.0",
        author = "lacus"
)
@StTag({
...
public class SqlServerSource extends AbstractStSource {
    ...
    @StField(
            ...
            enName = "table_path",
            cnName = "表路径",
            description = "表的完整路径，格式：database.schema.table",
            placeHolder = "test.dbo.users",
            formType = StField.FormType.TEXT
    )
