...
@StTag({
        ...
        @TagDefinition(name = "分区配置", displayName = "分区配置", order = 5, description = "并行分区相关配置"),
        @TagDefinition(name = "其他配置", displayName = "其他配置", order = 6, description = "其他扩展配置")
})
...
public class MysqlSource extends AbstractStSource {
    ...
    @StField(
            ...
            enName = "url",
            cnName = "JDBC连接URL",
            description = "MySQL数据库连接URL，格式：jdbc:mysql://host:port/database",
