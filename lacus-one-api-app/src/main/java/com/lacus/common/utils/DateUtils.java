...
public class DateUtils {
    ...
    public static final String STR_MS_PATTERN = "HH:mm:ss.SSS";
     ...
     * 日期型字符串转化为日期 格式
     */
    public static Date parseDate(Object str, String yyyyMmDdHhMmSs) {
        if (str == null) {
            return null;
        }
        try {
    ...
    public static Date getQuarterBegin(Date date) {
        ...
        // 设置日期为季度第一个月的第一天
        calendar.set(year, firstMonthOfQuarter, 1);
        return calendar.getTime();
    }
    ...
    public static Date getQuarterEnd(Date date) {
        ...
        // 设置日期为季度最后一个月的第一天
        calendar.set(year, lastMonthOfQuarter, 1);
        // 获取季度最后一个月的最大天数
    ...
    public static void main(String[] args) {
        ...
        System.out.println(DateUtils.format(new Date(), DateUtils.STR_MS_PATTERN));
    }
}
